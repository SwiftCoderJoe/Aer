...
module.exports = class UnbanCommand extends Command {
  ...
  run (msg, { user, reason }) {
    try {
      ...
      var strongRoles = config[msg.guild.id].modRoles //members that can unban users
      ...
      var canUnban = false
      callMemberRoles.some(function (requiredRole, _index1) {
        for (let role of strongRoles) {
